-- Script generante la struttura del DB e popola tutte le tabelle (eccetto sessione), utile per simulazioni pi� realistiche.
...
INSERT INTO rete_wifi (id, ssid, qualit�, latitudine, longitudine, numero_recensioni, necessit�_login, restrizioni, altre_informazioni, range_wifi, numero_segnalazioni, utente) VALUES
(1, 'tp-link', 4, 40.775132, 14.789021, 0, 0, 'Range di indirizzi IP limitato.\r\nBanda up/down inferiore alla media dei piani ADSL comuni.', 'Velocit� media download: 1Mbit/s\r\nVelocit� media upload: 10Kb/s', 50, 0, 2),
(2, 'Docenti', 5, 40.772143, 14.788932, 0, 1, 'Traffico controllato dagli amministratori di rete.', 'Velocit� media download: 5Mbit/s.\r\n\r\nPer il login alla rete pubblica sono richieste credenziali specifiche, contattare la segreteria.', 750, 0, 1),
(3, 'Studenti', 2, 40.772221, 14.790845, 0, 1, 'Traffico controllato dagli amministratori di rete.', 'Velocit� media download: 3Mbit/s.\r\n\r\nLa rete ha un timeout di 2 minuti di inattivit�.', 750, 0, 1),
...
(1, 5, 1, 'Errore: il range � limitato a 10 metri!', 0),
